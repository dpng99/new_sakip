...
if (isset($_SESSION['ID']) && isset($_SESSION['Pass'])) {
    ...
    if ($stmt) {
        ...
        if (mysqli_stmt_fetch($stmt)) {
            ...
            // Check if user is 'menpanrb' or '888881'
            if ($session_id == 'menpanrb' || $session_id == '888881') {
                ...
                // Get id_satker from the URL
                if (isset($_GET['id_satker'])) {
                    $id_satker_url = $_GET['id_satker'];

                    // Query to fetch details for the given id_satker
                    ...
                    $stmt_detil = mysqli_prepare($db, $query);
                    if ($stmt_detil) {
                        ...
                        mysqli_stmt_close($stmt_detil); // Close the detail statement
                    } else {
                        echo "Error preparing detail query: " . mysqli_error($db);
                    }
                } else {
